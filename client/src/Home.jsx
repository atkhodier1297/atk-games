    ...
    <div className="ui middle aligned stackable grid container">
      <div className="row">
        <div className="eight wide column">
          <h2 className="ui header" id="fonts">Mission Statement</h2>
          <h3 id="fonts">Our mission is simple, provide customers with a fantastic user experience buying video games!</h3>
          <h2 className="ui header" id="fonts">Browse our Collection</h2>
          ...
          <h2 id="fonts" className="ui header">About Us</h2>
